...
const char *hms_error_values[] PROGMEM = {
  ...
  "An abnormality happened in heating modules of heatbed before. To continue to use your printer, please refer to the wiki to troubleshoot.",
  ...
  "The chamber heater 1 works at full load for a long time. Temperature control system may be abnormal.",
  "The nozzle temperature is abnormal. Temperature control system may be abnormal.",
...
const char *device_error_values[] PROGMEM = {
  ...
  "Please pull out the filament on the spool holder from the extruder or check if there is filament broken in the extruder, and then click the retry button.",
  "Please pull out the filament on the spool holder from the extruder or check if there is filament broken in the extruder.",
  ...
  "Purged filaments have piled up in waste chute, which may cause a tool head collision. Please clean the filament. If cleaned or acceptable, tap the resume button to resume the print job.",
